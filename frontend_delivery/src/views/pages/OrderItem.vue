        ...
        #{{props.order?.order_id}}
            ...
            <div v-for="product in props.order.products.slice(0,3)" style="width: 3rem;height:100%;">
                <div style="position: relative;">
                    <img style="width: 100%; border-radius: 10%;background-color: white;object-fit: cover;aspect-ratio: 1 / 1;" :src="`${URI}/read-photo-product/${product.img_identifier}/96`" alt="">
